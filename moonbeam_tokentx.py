...
df_related_addresses.to_csv(r"D:\sybil\moonbeam_tokentx_related_address_pairs.csv", index=False)

print("Related address pairs on Moonbeam have been saved to moonbeam_tokentx_related_address_pairs.csv.")
