...
data = pd.read_csv(r"D:\sybil\moonbeam_tokentx_related_address_pairs.csv")
...
output_df.to_csv(r"D:\sybil\moonbeam_tokentx_large_connected_groups.csv", index=False)
