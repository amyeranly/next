...
df_related_addresses.to_csv(r"D:\sybil\moonbeam_txlist_related_address_pairs.csv", index=False)

print("Related address pairs on Moonbeam have been saved to moonbeam_txlist_related_address_pairs.csv.")
