...
def get_transactions_arbitrum(address, api_key):
    ...
    if data["status"] == "1":
        ...
        print(f"Error fetching transactions for address {address} on ETH: {data['message']}")
        return []

groups_df = pd.read_csv(r"D:\sybil\arbitrum_txlist_large_connected_groups.csv")
...
# save
output_file_path = r"D:\sybil\arbitrum_txlist_token_transfers_per_group.csv"
