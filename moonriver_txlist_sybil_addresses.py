...
data = pd.read_csv(r"D:\sybil\moonriver_txlist_related_address_pairs.csv")
...
output_df.to_csv(r"D:\sybil\moonriver_txlist_large_connected_groups.csv", index=False)
